...
def get_dataset_text_loader(opt_path, batch_size, device,
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        ...
        opt.m_token_dir = pjoin(opt.data_root, tokenizer_name)
        opt.n_mot_vocab = codebook_size + 3
        opt.mot_start_idx = codebook_size
        opt.mot_end_idx = codebook_size + 1
        opt.mot_pad_idx = codebook_size + 2
