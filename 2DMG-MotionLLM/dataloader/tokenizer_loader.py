...
class VQMotionDataset_start0(data.Dataset):
    def __init__(self, dataset_name, feat_bias=5, window_size=64, unit_length=8):
        self.window_size = window_size
        self.unit_length = unit_length
        self.feat_bias = feat_bias
...
def DATALoader_start0(dataset_name,
                batch_size = 1,
                num_workers = 8, unit_length = 4) :

    train_loader = torch.utils.data.DataLoader(VQMotionDataset_start0(dataset_name, unit_length=unit_length),
                                              batch_size,
                                              shuffle=True,
                                              num_workers=num_workers,
                                              drop_last = True)
