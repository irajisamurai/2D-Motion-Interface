...
from utils.instruction_templates import tdt2m_template_list
...
# 3. load data
class TDT2MDataset(Dataset):
    def __init__(self, tokenizer, split='train', source_len=1536, target_len=256, unit_length=4):
        # t2m
...
if __name__ == "__main__":
    ...
    train_dataset = TDT2MDataset(tokenizer, split='train')
    val_dataset = TDT2MDataset(tokenizer, split='val')
