...
if __name__ == "__main__":
    ...
    parser.add_argument("--token_dir", type=str, default="VQVAE",
                        help="Sub-directory under dataset root for tokens")
    ...
    train_dataset = M2TDataset(tokenizer, split='train', token_dir=args.token_dir)
    val_dataset = M2TDataset(tokenizer, split='val', token_dir=args.token_dir)
