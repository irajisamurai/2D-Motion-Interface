...
<img src="Assets/demo_1.gif" width="100%" alt="Demo: a monocular real video of a person sitting down cross-legged and standing back up, with the estimated ViTPose 2D keypoints overlaid, and the caption predicted by our 2D Motion Interface shown underneath.">

<sub>A monocular real video with the estimated <b>ViTPose 2D keypoints</b> overlaid. The caption underneath is generated by our 2D Motion Interface — <b>no 3D pose estimation anywhere in the pipeline</b>.
